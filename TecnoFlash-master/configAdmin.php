    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">TechnoFlash</small></h1>
            </div>
            <!-- Nav tabs -->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <label>Nombre de del servicio</label>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading text-center"><i class="fa fa-refresh fa-2x"></i><h3>Actualizar datos de servicios</h3></div>
