        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registrarse Como Cliente<small class="tittles-pages-logo"> TechoFlash </small><i class="fa fa-bolt" aria-hidden="true"></i></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    <p><i class="fa fa-users fa-5x"></i></p>
                    <p class="lead">
                        Ofrecemos diversos servicios de telefonia y computacion
                    </p>
                    <br>
                    <img src="assets/img/logos.png" alt="Logos" class="img-responsive">
                </div>
